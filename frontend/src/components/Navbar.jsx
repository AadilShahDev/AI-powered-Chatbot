  ...
  return (
    <>
      ...
      <button
        ...
        className="fixed top-4 left-4 z-50 bg-white border border-gray-300 p-2 rounded-lg shadow hover:bg-pink-50 transition"
      >
      ...
      {/* Sidebar */}
      <div
        className={`fixed top-0 left-0 h-full w-64 bg-white border-r border-gray-200 shadow-md z-40 transform transition-transform duration-300 ease-in-out ${
      ...
      >
        ...
        {/* Sidebar Content */}
        <div className="p-6">
          <h2 className="text-2xl font-bold text-pink-600 mb-6">AAWAI</h2>
          <ul className="space-y-4 text-lg font-medium text-gray-800">
            <li>
              <Link to="/" onClick={toggleSidebar} className="hover:text-pink-600 transition">Home</Link>
            </li>
            <li>
              <Link to="/chatbots" onClick={toggleSidebar} className="hover:text-pink-600 transition">Chatbots</Link>
            </li>
            <li>
              <Link to="/tti" onClick={toggleSidebar} className="hover:text-pink-600 transition">Text-to-Image</Link>
            </li>
            <li>
              <Link to="/logout" onClick={toggleSidebar} className="hover:text-pink-600 transition">Logout</Link>
            </li>
          </ul>
        </div>
      </div>
