...
function Home() {
  ...
  return (
    <div className="min-h-screen bg-white flex flex-col items-center justify-start px-4 pt-24 pb-16 text-gray-800">
      {/* Heading */}
      <h1 className="text-4xl font-bold mb-4 text-center text-pink-600">Welcome to AAW-AI</h1>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 max-w-5xl w-full">
        ...
        <div className="bg-pink-50 p-6 rounded-xl shadow hover:shadow-lg transition-all">
          ...
          <Link to="/chatbots/gemini">
            <button className="px-4 py-2 bg-pink-600 text-white rounded-full hover:bg-pink-700" onClick={navigate('/models')}>
              Try Gemini
            </button>
          </Link>
        </div>
